...
public abstract class Variable implements Serializable {
	 ...
	 * 
	 * @param typeName Nazwa typu zmiennej.
	 ...
	 * 
	 * @param typeName Nazwa typu zmiennej kontenerowej.
	 * @param elementTypeName Nazwa typu przechowywanych danych.
	 ...
	 * Tworzy pustą zmienną kontenerową służącą do przechowywania określonego typu zmiennych.
	 * 
	 * @param typeName Typ zmiennej kontenerowej.
	 * @param elementTypeName Typ przechowywanych danych.
	 * @return Pusta zmienna kontenerowa stworzona wg parametrów.
	 */
	...
	public static final Variable createByValue(String value) {
		...
		if (value.matches(INT_REGEX)) {
			...
			VInteger intVar = (VInteger) Variable
					.createSimple(VarType.INTEGER.toString());
			intVar.setValue(new VInteger(Long.parseLong(value)));
		...
		if(value.matches(FLOAT_REGEX)) {
			VFloat floatVar = (VFloat)Variable.createSimple(VarType.FLOAT.toString());
			floatVar.setValue(new VFloat(Double.parseDouble(value)));
			
			return floatVar;
		}
		if(value.matches(BOOLEAN_REGEX)) {
			VBoolean booleanVar = (VBoolean)Variable.createSimple(VarType.BOOLEAN.toString());
